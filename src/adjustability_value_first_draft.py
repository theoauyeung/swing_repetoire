...
Output: data/adjustability.parquet (updated), results/adjustability_value_first_draft.md
Run   : python src/adjustability_value_first_draft.py
"""
...
def main():
    ...
    out = ROOT / "results" / "adjustability_value_first_draft.md"
    header = [
        "# Adjustability value\n",
    ...
    #
    # To run: uncomment the block below and execute `python src/adjustability_value_first_draft.py`
    #
