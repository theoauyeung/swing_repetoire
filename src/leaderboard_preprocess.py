...
con = db.connect("swings", "xrv_swings", "cluster_assignments")
...
con.sql(f"""
    ...
    TO '{ROOT}/data/r_batter_names.parquet' (FORMAT PARQUET)
""")
...
con.sql(f"""
    ...
    ) TO '{ROOT}/data/r_swing_plus_shape.parquet' (FORMAT PARQUET)
""")
...
con.sql(f"""
    COPY (
        ...
        GROUP BY batter_id
    ) TO '{ROOT}/data/r_swing_plus_batter.parquet' (FORMAT PARQUET)
""")
...
con.sql(f"""
    ...
    ) TO '{ROOT}/data/r_swing_plus_unit.parquet' (FORMAT PARQUET)
""")
