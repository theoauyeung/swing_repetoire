...
Output: data/adjustability_value.parquet
Run   : python src/adjustability_value.py            (full, ~25 min)
...
def main():
    ...
    out = DATA / ("adjustability_value_subset.parquet" if args.limit else "adjustability_value.parquet")
